export default {
  ...
  pages: {
    ...
    projects: {
      ...
      timephp: "Lightweight PHP MVC framework.",
      rainbowConsole:
        "A very lightweight php library to color text in the console.",
      codeplate: "Desktop app to manage community boilerplates.",
      madeWithCollection:
      ...
      shortly: "Very simple url shortner made with AdonisJS.",
      tinydb: "Json based database for tiny Php projects.",
      hashtag: "Desktop app to easily hash things.",
      quicklog: "Simple password manager made with Electron and Vuejs.",
      linuxAutohost:
      ...
      flappy: "Obviously, this is the FlappyBird game written in Processing.",
      apod: "Once again, this a Twitter bot that post the picture of the day from the Nasa API every day.",
      iss: "Twitter bot that post the position of the ISS every hour.",
      vykon:
        "12th grade final project. This is a Power 4 with an 'AI' written in Python.",
      gameOfLifeTitle: "Game of life",
      gameOfLife: "Simple implementation of the Game of life using Processing.",
      langtonTitle: "Langton's ant",
      langton: "Langton's ant implementation written in Processing.",
    },
    tools: {
      description:
        "Here is a list of tools and software that I use every day as a software engineer.",
      ...
      dribbble: "Best website to get inspired.",
      pinterest: "Infinite source of inspiration.",
      ...
      pomotroid: "Small but very efficient pomodoro timer.",
      todoist: "Helpful to schedule my time.",
      astral: "Web application to manage github stars.",
      office365: "Obviously 😄",
      carbon: "Share pieces of code with syntax highlighting.",

      messenging: "Messenging",
      discord: "Organize conversations, communities, servers, ...",
      ...
      githubBlog: "Ideas to help developers build better softwares.",
      ...
      design: "Design",
      figma: "Excellent for creation and prototyping.",
      colorHunt: "Simple website that generated color palettes.",

      terminals: "Terminals",
      terminal: "CMD on steroids 💪",
      gitBash: "Simple terminal with linux commands support.",
      ...
      docker: "Accelerate the way to build apps.",
      ...
      githubCodespace: "This allows me to code wherever I want.",
      composer: "PHP package manager.",
      regex101: "Build and (hopefully) understand regex.",

      other: "Other softwares",
      brave: "Chrome with privary.",
      spotify: "Start VSCode, play your playlist and enjoy coding.",
      powertoys: "Utilitary tools to enjoy using windows everyday.",

      chrome: "Chrome extensions",
      vueDevtool: "Understand and debug vue behaviour.",
      jsonFormatter: "Give json pages a better look.",
      ...
      gitlens: "Achieve complex git tasks.",
      ...
      githubCodespace2: "To be able to connect vscode to a remote codespace.",
      ...
      vuejs: "I used to use React, and then, I discovered Vue.js 💗",
      vitejs: "Speed up the development process.",
      bootstrap: "Good for prototyping.",
      laravel: "A very pleasant backend framework.",
      electron: "Convert websites into desktop apps.",
      nuxt: "Quickly create Vue.js web apps without spending time to configure everythings.",
    },
    about: {
      text1:
    ...
    experience: {
      ...
      icohupStage: {
        ...
        from: "July 2019",
        actions: [
          "Research to determine the language best suited to the needs of the company",
          "Creation of REST APIs distributing data stored in database using multiple languages (PHP, Python, Go, Javascript)",
          "Drafting of technical documentation",
          "Creating asynchronous programs in Python",
        ],
      },
      mantesLajolieStage: {
        ...
        actions: [
          ...
          "Improvement of the automatic sending of existing mails by adding an automation system",
          "Research and implementation and deployment of a code version manager (GitLab)",
